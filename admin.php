...
<h3 class="titlehdr">Admin CP</h3>
	...
	if(!empty($err))  {
      ...
      <p>Here you can manage all users on the website</p>
	  ...
	  ?></p>
      <table width="80%" border="0" align="center" cellpadding="10" cellspacing="0" style="background-color: #FFF;padding: 2px 5px;border: 1px solid #000;" >
        <tr>
	  ...
	  // outputting the pages
        ...
        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
		  ...
		  <div style="color:#000000" id="msg<?php echo $rrows['id']; ?>" name="msg<?php echo $rrows['id']; ?>"></div>
		  </div>
...
echo "<div class=\"msg\">User created with password $pwd....done.</div>"; 
      ...
      <h2><font color="#000000">Create New User</font></h2>
