...
define ("DB_USER", "jakeodon"); // set database user
define ("DB_PASS","0u!0fash0E"); // set database password
define ("DB_NAME","jakeodon_login"); // set database name
...
/*************** reCAPTCHA KEYS****************/
$publickey = "6Leort8SAAAAAM_9Q99iLm3EHCQaqHdwyFnVh1QN";
$privatekey = "6Leort8SAAAAANmQY4fbr_nPxuX6WhSL8KaWUsVr";
