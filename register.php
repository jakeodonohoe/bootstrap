...
<html lang="en">
  ...
  <tr> 
	...
	?></p>
      ...
      <p>Please register to gain full access to the website <span class="required">*</span> 
        are required.</p>
	 <?php	
	 if(!empty($err))  {
	   echo "<div class=\"msg\">";
	 ...
	 ?> 
      ...
      <form action="register.php" method="post" name="regForm" id="regForm" >
        <table width="95%" border="0" cellpadding="3" cellspacing="3" class="forms">
          ...
          <tr> 
            <td colspan="2">Contact Address (with Postcode)<span class="required"><font color="#CC0000">*</font></span><br> 
